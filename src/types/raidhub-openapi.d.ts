        ...
        get: {
            parameters: {
                query: {
                    ...
                    count?: number
                    category:
                        | ("normal" | "prestige" | "challenge" | "master")
                        | ("fresh" | "clears" | "sherpas" | "trios" | "duos" | "solos")
                        | ("clears" | "sherpas" | "fresh" | "speed")
                    raid?: number
                }
            }
            responses: {
...
export interface components {
    schemas: {
            ...
            readonly entries: readonly {
                readonly player: {
                    readonly destinyUserInfo: {
                        ...
                        readonly applicableMembershipTypes?:
                            | readonly components["schemas"]["BungieMembershipType"][]
                            | null
                        readonly membershipType?: components["schemas"]["BungieMembershipType"]
                        readonly membershipId: string
                        readonly displayName?: string | null
        ...
        readonly LeaderboardSearchResponse: {
            ...
            readonly position: number
            readonly entries: readonly (
                | components["schemas"]["IndividualLeaderboardEntry"]
                | components["schemas"]["WorldFirstLeaderboardEntry"]
            )[]
        }
