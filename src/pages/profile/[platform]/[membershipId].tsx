...
export async function getServerSideProps({ params }: { params: { platform: string, membershipId: string } }): Promise<{ props: InitialProfileProps }> {
  ...
  return { props: { bungieNetProfile: profile.success ?? undefined, error: profile.error?.message ?? "" } }
}
