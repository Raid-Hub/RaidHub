            ...
            <main className={styles["main"]}>
                ...
                <section className={styles["section"]}>
                    ...
                    <p>
                        ...
                        IBA by a member company, the member company must set an &quot;opt-out
                        cookie&quot; on the consumer&apos;s browser. Please note that if you delete
                        any opt-out cookies obtained using the NAI opt-out page, such as by clearing
                        all cookies in your browser, you will need to return to the opt-out page to
                        renew your choices. However, the DAA offers a tool that helps to preserve
                        your opt-out cookies and prevent them from being deleted. To learn more
                        about how our opt-out process works, click here.
                    </p>
                    <h2>Google Adsense</h2>
                    <p>
                        Some of the ads may be served by Google. Google may use cookies to serve ads
                        based on a User&apos;s prior visits to the Site or other websites.
                        Google&apos;s use of advertising cookies enables it and its partners to
                        serve ads to a User based on their visit to your sites and/or other sites on
                        the Internet. Users may opt out of personalized advertising by visiting
                        adssettings.google.com. Some of the ads may be served by third-party vendors
                        and ad networks. A User can opt out of a third-party vendor&apos;s use of
