...
const PrivacyPage: NextPage = () => {
    return (
        <>
            <Head>
                <title key="title">Privacy Policy | RaidHub</title>
            </Head>
            <main className={styles["main"]}>
                ...
                <section className={styles["section"]}>
                    <p>
                        ...
                        the raidhub.app website ("Site"). This privacy policy applies to the Site
                        and all products and services offered by RaidHub.
                    </p>
                    ...
                    <p>
                        ...
                        services, including their content and links, may be constantly changing.
                    ...
                    <p>
                        ...
                        advertisers. In addition, NAI member companies serve cookies via this
                        website as part of the opt-out process. To enable a consumer to opt out of
                        IBA by a member company, the member company must set an "opt-out cookie" on
                        the consumer's browser. Please note that if you delete any opt-out cookies
                        obtained using the NAI opt-out page, such as by clearing all cookies in your
                        browser, you will need to return to the opt-out page to renew your choices.
                        However, the DAA offers a tool that helps to preserve your opt-out cookies
                        and prevent them from being deleted. To learn more about how our opt-out
                        process works, click here.
                    </p>
                    <h2>Google Adsense</h2>
                    <p>
                        Some of the ads may be served by Google. Google may use cookies to serve ads
                        based on a User’s prior visits to the Site or other websites. Google's use
                        of advertising cookies enables it and its partners to serve ads to a User
                        based on their visit to your sites and/or other sites on the Internet. Users
                        may opt out of personalized advertising by visiting adssettings.google.com.
                        Some of the ads may be served by third-party vendors and ad networks. A User
                        can opt out of a third-party vendor's use of cookies for personalized
                    ...
                    <p>
                        ...
                        also choose to disable cookies entirely in your internet browser, but this
                    ...
                    <ol type="1">
                        ...
                        <p>
                            ...
                            Site so that your selections are saved for your next visits; and
                        </p>
                        ...
                        <ol type="a">
                            <li>
                                Monitoring user preferences for the online advertisement industry.
                            </li>
                        </ol>
                    </ol>
                    <h2>Modifications</h2>
                    ...
                    <p>
                        Users who create an account consent to the collection of data for the
                        purpose of statistics and online advertising.
                    </p>
                    <p>
                    ...
                    <p>
                        raidhub.app (the "Site") is owned and operated by RaidHub. RaidHub can be
                        contacted at: support@raidhub.app
                    </p>
                </section>
            </main>
        </>
