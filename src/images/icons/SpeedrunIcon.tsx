...
import SVG, { SvgParentProps } from "~/components/reusable/SVG"
import styles from "./svgs.module.css"

export default React.forwardRef<SVGSVGElement, SvgParentProps & React.SVGProps<SVGSVGElement>>(
    function SpeedrunIcon({ color, ...props }, ref) {
        const styleProps = color
            ...
            : undefined
        return (
            <SVG ref={ref} viewBox="0 -6.5 102 102" fillRule="evenodd" {...styleProps} {...props}>
                <g shape-rendering="crispEdges">
                    ...
                    <path
                        fill="#c36f09"
                        d="M92.825.47h4.4v4.4h-4.4zM88.425 31.29h4.4v4.4h-4.4z"></path>
                    ...
                    <path
                        fill="#c36f09"
                        d="M88.425.47h4.4v4.4h-4.4zM84.025 35.69h4.4v4.4h-4.4z"></path>
                    ...
                    <path
                        fill="#b55608"
                        d="M84.025.47h4.4v4.4h-4.4zM79.625 35.69h4.4v4.4h-4.4z"></path>
                    <path
                        fill="#ffd95c"
