...
const ClanBanner = ({ gonfalcons, decalTop, decalSecondary, decalPrimary }: ClanBannerProps) => {
    return (
        <>
            {/* <img src={`https://bungie.net${gonfalcons.path}`} />
            <img src={`https://bungie.net${decalTop.path}`} /> */}
            {/* <img src={`https://bungie.net${decalPrimary.path}`} />
            <img src={`https://bungie.net${decalSecondary.path}`} /> */}
            <svg
