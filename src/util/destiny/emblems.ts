...
export function bannerEmblemFromCache(emblem: DestinyInventoryItemDefinition | null) {
    // the www here is very important...please do not remove it
    return "https://www.bungie.net" + (emblem?.secondarySpecial ?? defaultBannerEmblem)
}
